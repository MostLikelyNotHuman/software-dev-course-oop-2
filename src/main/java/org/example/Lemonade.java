...
public class Lemonade {
    ...
    public static Lemonade mix(Lemonade lemonade1, Lemonade lemonade2) {
        ...
        int sumLemons = lemonade1.getLemons() + lemonade2.getLemons();
        int sumSugar = lemonade1.getSugar() + lemonade2.getSugar();
        int sumIce = lemonade1.getIce() + lemonade2.getIce();
        return new Lemonade(sumLemons, sumSugar, sumIce);
